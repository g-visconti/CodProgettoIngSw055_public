...
/**
 * Data Transfer Object (DTO) per rappresentare lo storico delle offerte ricevute
 * sugli immobili di un agente immobiliare.
 *
 * <p>Questa classe contiene tutte le informazioni necessarie per visualizzare
 * lo storico delle proposte ricevute da un agente, inclusi dettagli dell'immobile,
 * dell'offerta e del suo stato attuale.
 *
...
public class StoricoAgenteDTO {
	...
	/**
	 * Costruttore vuoto per StoricoAgenteDTO.
	...
	/**
	 * Costruttore completo per StoricoAgenteDTO.
	 * Inizializza tutte le proprietà dell'offerta storica con i valori forniti.
	 *
	 ...
	 * @param dataOfferta Data e ora in cui è stata ricevuta l'offerta
	...
	/**
	 * Restituisce una descrizione breve dell'immobile, troncata a 100 caratteri.
	 * Se la descrizione è più lunga di 100 caratteri, viene aggiunto "..." alla fine.
	 *
	 * @return Descrizione breve dell'immobile (massimo 100 caratteri)
	 */
	...
	/**
	 * Restituisce la data dell'offerta formattata come stringa della sola data (senza ora).
	 * Se la data è null, restituisce una stringa vuota.
	 *
	 * @return Data formattata dell'offerta nel formato "YYYY-MM-DD" o stringa vuota
	 */
	public String getDataFormattata() {
		if (dataOfferta == null) {
			return "";
		}
		return dataOfferta.toLocalDate().toString();
	}
	...
	/**
	 * Restituisce la data e ora in cui è stata ricevuta l'offerta.
	 *
	...
	/**
	 * Imposta la data e ora in cui è stata ricevuta l'offerta.
	 *
	 ...
	 * Il formato è: "Offerta #[id] [stato] - [categoria] - [importo]"
	 *
